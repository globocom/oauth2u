...
def save_new_authorization_code(auth_code, client_id, state, redirect_uri):
...
def get_state(client_id, auth_code):
    return DATABASE[client_id]['authorization_codes'][auth_code]['state']
